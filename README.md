...
```javascript
import bifurcateEntriesBy from 'https://cdn.jsdelivr.net/gh/stdlib-js/array-base-bifurcate-entries-by@v0.1.0-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/array-base-bifurcate-entries-by/actions/workflows/test.yml/badge.svg?branch=v0.1.0
[test-url]: https://github.com/stdlib-js/array-base-bifurcate-entries-by/actions/workflows/test.yml?query=branch:v0.1.0
